package com.example.an.testdemo.itemDecorationType.Activity;
...
import com.example.an.testdemo.itemDecorationType.Adapter.SimpleAdapter;
...
public class SimpleDecorationActivity extends AppCompatActivity {
    ...
    public static void startActivity(Activity activity) {
        Intent intent = new Intent(activity, SimpleDecorationActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_simple:
                SimpleDecorationActivity.startActivity(this);
                return true;

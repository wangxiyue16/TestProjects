...
import com.example.an.recycleviewdemo.StaggeredHomeAdapter.OnItemClickLitener;
		...
		mStaggeredHomeAdapter.setOnItemClickLitener(new OnItemClickLitener()
		{
			...
			public void onItemClick(View view, int position)
			{
				Toast.makeText(StaggeredGridLayoutActivity.this,
						"我在第" + position + "个位置," + "我被点中了,快来救我!", Toast.LENGTH_SHORT).show();
			}
			...
			{
				Toast.makeText(StaggeredGridLayoutActivity.this,
						"我在第" + position + "个位置," + "我要被杀死了,快来救我!", Toast.LENGTH_SHORT).show();
			}
		});
	}
